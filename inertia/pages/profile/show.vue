    ...
    >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div
          ...
          :key="pack.name"
          class="p-4 border rounded-lg shadow hover:shadow-md transition flex flex-col justify-between"
        >
          <div>
            ...
            <p class="text-gray-700">
              ...
              <span v-if="pack.bonusCoin" class="text-green-600 font-semibold">
